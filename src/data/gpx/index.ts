...
import holland from "./holland.json";
import belgium from "./belgium.json";
import normandy from "./normandy.json";
import loire from "./loire.json";
import alsace from "./alsace.json";  
import forest_switzerland from "./forest_switzerland.json";
import alpine_switzerland from "./alpine_switzerland.json";
import lombardy from "./lombardy.json";
import veneto from "./veneto.json";
import slovenia from "./slovenia.json";
import croatia from "./croatia.json";
import south_balkans from "./south_balkans.json";
