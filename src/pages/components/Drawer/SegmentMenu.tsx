...
const SegmentSquare = ({segment, imgString}: {segment: Segment, imgString: string}) => {
    ...
    return (
        <div className="nil:w-full nil:h-full sm:w-full sm:h-full md:w-1/2 md:h-1/2 lg:w-1/3 lg:h-1/3 flex flex-col items-center justify-around font-mapheader cursor-pointer bg-tan transition-colors ease-in-out duration-300 hover:bg-statgreenborder">
