...
const Chevron = () => {
    ...
    return (
        <div className={`nil:hidden sm:hidden md:hidden lg:flex w-5/12 h-8 bg-statblack -translate-y-4 translate-x-6 flex flex-row justify-center items-center ${text} ${before} drop-shadow-xl`}>
            <MdLocationOn />
